...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Analiza przestrzeni stanów jest możliwa wyłącznie dla bardzo ograniczonej przestrzeni stanów:
			...
			\end{itemize}
		\item Należy zmieniać strategię w~zależności od fazy rozgrywki:
			\begin{description}
				\item[Pierwszy ruch] maksymalizacja liczby zdobytych punktów.
				\item[MG] algorytm heurystyczny z~symulacją w~przód.
				\item[PEG, EG] przeszukiwanie przestrzeni stanów z~ograniczeniami.
			\end{description}
	\end{itemize}
\end{frame}
